...
h5. Missing udebs
 ...
 Next part is where actually broken intaller fixed, here we will add
 missing drivers. 
...
h5. Preseeding
 ...
 Automation of Cobller installs is done by "preseed":seed file. Preseed
 ...
 There are several ways to do this. If you are using prebuilt
 intaller, you can add @preseed.cfg@ file to it. Simple "shell script":make-preseed
 can help with this.
...
h2. Install
 ...
 Copy all subdirectory @dest/netboot/debian-installer/amd64@ to
 Cobbler's
