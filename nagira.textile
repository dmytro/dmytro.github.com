 ...
 **Please note**: There's is different Open Source implementation of the
 RESTful API for Nagios, which superseeds this --
 "Nagira":http://dmytro.github.com/Nagira . Nagira implemented with
 Ruby and Sinatra, provides more functionality/test suite, easier
 configuration. 
 
 Although similar in functionality code bases of two
 systems are not related.

 This page on ly provides description of older API, if you are looking
 for working software look at
 "Nagira":http://dmytro.github.com/Nagira instead.
